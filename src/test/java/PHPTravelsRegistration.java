...
public class PHPTravelsRegistration extends BaseTestClass {
    ...
    public void enterDifferentWrongData(String firstName, String lastName) {
        ...
        home = new HomePage(driver);
        doAssertEqual(home.getCurrentUrl().contains("register"), true, "URL is wrong, hence user is registered");
        softAssert.assertAll();
    }
    ...
    public Object[][] getData() {
        ...
        data[0][0] = "Abc";
        data[0][1] = ""; //empty first name
        data[1][0] = "   ";
        data[1][1] = "Abc"; //empty last name
        data[2][0] = "    ";
        data[2][1] = "    "; //white spaces
        return data;
    }
